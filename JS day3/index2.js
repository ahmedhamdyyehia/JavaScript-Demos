...
function date(d){
reps=["jan","feb","march","ibr","may","jun","jul","aug","sep","oct","nov","des"]
 return reps[d.getMonth()];
}
console.log(date(new Date("10/5/2010")));
...
/*
  ...
  function sumInput() {
    ...
    while (true) {
        ...
        value = parseInt(prompt("enter your number please?"));
        summ+=value;
       if (value == 0 || summ>100)
        break;
    }
